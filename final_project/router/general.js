...
public_users.post("/register", (req, res) => {
  ...
  return res
    .status(400)
    .json({
      message: "Unable to register user. Username or password not provided.",
    });
});
...
// Task 12: Get book details by ISBN - Using Promise callbacks
...
// Task 13: Get book details by Author - Using async/await for cleaner syntax
...
// Task 14: Get book details by Title - Using Promise to handle async request
